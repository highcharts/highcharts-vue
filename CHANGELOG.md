...
### [2.0.2](https://github.com/highcharts/highcharts-vue/compare/v2.0.1...v2.0.2) (2025-08-18)

- Fixed [#282](https://github.com/highcharts/highcharts-vue/issues/282), `app.use()` failing on Vite 8 due to CJS default export interop.
- Fixed [#263](https://github.com/highcharts/highcharts-vue/pull/263), null reference error on update.
